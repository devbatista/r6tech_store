...
Rails.application.configure do
  ...
  # Uploads no Amazon S3: o container é efêmero, então o disco local perderia as imagens
  # de produto, o logo e as imagens geradas por IA a cada deploy (see config/storage.yml).
  ...
  # config.active_job.queue_name_prefix = "r6tech_store_production"
